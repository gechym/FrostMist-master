                    ...
                    return (
                        <div
                            ...
                            <Avatar
                                ...
                                alt='avatar'
                                className='w-10 h-10 bg-white border-[1px] border-[#1B74E4] '
                            />
        ...
        <div className='overflow-x-hidden'>
            <div className='overflow-x-hidden'>
                ...
                <div className='flex items-center transition-50 my-1 pr-2 '>
                    {state.isNewMessage ? (
                        <div className='my-3 bg-[#1B74E4] dark:bg-[#252F3C] w-full py-2 text-white rounded-lg '>
                        ...
                        <div className='flex rounded-2xl md:rounded-full w-full border-[1px] border-[#1B74E4] px-1 md:px-2 my-2 '>
                            <input
                                type='text'
