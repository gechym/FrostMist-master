                        ...
                        {c.sentBy._id === user._id ? (
                            ...
                            <div
                                ...
                                <Avatar
                                    ...
                                    className='mr-1 border-[1px] border-[#1B74E4] rounded-full w-8 h-8 cursor-pointer '
                                    alt='AVATAR'
                                />
                    ...
                    <div className='flex flex-wrap items-center py-1 create-new-message gap-x-1 '>
                            ...
                            {state.listResultByPeopleSearch.length > 0 &&
                                state.listResultByPeopleSearch.map((l, k) => (
                                    <span
                                        key={k}
                                        role='button'
                                        className='flex items-center py-0.5 px-3 gap-x-0.5 text-white rounded-full bg-[#1B74E4] dark:bg-[#3A3B3C] mt-1 md:mt-0 '>
                                        {l ? l.name : "nothing"}
                                        {l.role === "Admin" && (
                        ...
                        <div className='mt-1 ip md:mt-0 '>
                            <input
                                ...
                                className='rounded-full border-[#1B74E4] dark:border-0 focus:ring-0 dark:focus:border-0 pl-3 dark:bg-[#3A3B3C] dark:text-[#e4e6eb] dark:placeholder:text-[#e4e6eb] py-1 md:py-1.5 w-[150px] md:w-auto text-[14px] md:text-base mt-0 '
                                        ...
                                        (v, k) => (
                                            <Tooltip
                                                ...
                                                <Avatar
                                                    ...
                                                    alt='avatar'
                                                    className='w-10 h-10 bg-white border-[#1B74E4] cursor-pointer border dark:border-white '
                                                    onClick={() =>
