                    ...
                    {!state.allMessages.length && !state.isNewMessage ? (
                        ...
                        <form
                            ...
                            <div className='w-full rounded-full flex gap-x-2 items-center relative '>
                                {image?.url && (
                                    <div className='absolute w-[200px] h-[100px] md:w-[400px] md:h-[200px] rounded-md dark:bg-[#18191A] border dark:border-white/50 top-[-120px] md:top-[-220px] right-[60px] z-[20] flex items-center justify-center bg-[#1B74E4] border-[#333]/70 '>
                                        {state.loading && (
                                ...
                                <input
                                    type='text'
                                    className='w-full bg-inherit first-line:focus:ring-0 focus:ring-white rounded-full border-[1px] border-[#1B74E4] flex px-4 items-center '
