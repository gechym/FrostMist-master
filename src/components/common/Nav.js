    ...
    <div className="flex fixed top-0 w-screen bg-white px-1 sm:px-2 md:px-4 z-[100] items-center dark:bg-[#242526] transition-50 dark:text-[#DDDFE3] border-b-[#8a8a8a] py-1 ">
      ...
      >
        {user ? (
          ...
          <>
            <NavLink
              to="/home"
              className={`relative bg-inherit text-[#1B74E4] py-2 md:py-2.5 my-1 mx-1 shrink-1 w-full flex justify-center hover:text-[#1B74E4] hover:bg-[#EBEDF0] rounded-[10px] text-[23px] transition-20 after:content-[''] after:absolute after:h-[3px] after:w-[70%] after:left-[15%] after:bg-[#1B74E4] after:opacity-0 after:bottom-0 -['Home']  before:rounded-lg dark:bg-inherit before:opacity-0 dark:text-[#B8BBBF] dark:hover:bg-[#3A3B3C] dark:hover:text-[#d2d5d7] `}
              role="button"
            >
              <AiFillHome />
            </NavLink>
      ...
      >
        <div className="flex items-center">
          {user && (
            <div className="text-sm md:text-md font-semibold border pl-3 md:pr-5 py-[5px] rounded-l-full translate-x-[16px] bg-[#1B74E4] text-white dark:bg-[#3A3A3A] dark:border-white/30 hidden md:flex ">
              {user.name}
            </div>
          )}
          <Dropdown />
